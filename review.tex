...
Now to run EM, we simply need to derive an analytical expression for $\lag(P(Z|X, \theta), \theta)$ and then repeatedly maximize with respect to $\theta$ until we converge at the optimal solution.
