...
\todo{multivariate normal case of conjugate priors (wishart)}
...
\todo{check that this is equiv to MP}
...
\todo{finish after variation section is done}
...
The final piece of this puzzle is to prove that the gumbel trick actually works.
